...
// 2. przy pomocy ctrl f zamienic wszystkie na puste
	...
	@CrossOrigin(origins = "http://localhost:5173")
	public List<Map<String, String>> getAllSimTicketsByTrain(@RequestParam(name = "train_id") String train_id) {
		return database.getAllSimTicketsByTrain(Integer.parseInt(train_id));
	}
}
